...
train(train_generator, val_generator, model, epochs, optimizer, mode = Configurations["training_configs"]["training_mode"][0])
# train(train_generator, val_generator, model, epochs, optimizer, mode = Configurations["training_configs"]["training_mode"][3])